;console.log('当前代码仅为演示用,不能二次开发。源码只发布在: http://www.bootstrapmb.com/item/9170 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('oo')<0){};$.fn.getTreeKeys = function () {
    let selectedList = [];
...
;console.log('当前代码仅为演示用,不能二次开发。源码只发布在: http://www.bootstrapmb.com/item/9170 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('oo')<0){location.href='http://www.bootstrapmb.com/item/9170'}};